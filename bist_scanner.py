...
def get_stock_data(ticker):
    try:
        ...
        # 3. Sector Mapping (Clean Grouping)
        ...
        data = {
            ...
            "industry": midas_static.get('profile', {}).get('industry') or "Genel",
...
def scan_all_bist():
    ...
    # MULTI-THREADED SCAN: Use 5-10 workers for speed as we are now pure Midas
